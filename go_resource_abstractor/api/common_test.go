...
// TestMalformedIDIs400 guards the 500->400 fix: a path id that isn't a
// valid hex ObjectID must be rejected with 400 rather than falling through
// to the store, hitting bson.ObjectIDFromHex, and 500ing. PatchResource and
// GetHook are deliberate exceptions - they already answered 404 for an
// invalid id and keep doing so.
