...
// AppFilter narrows AppsClient.List. The functions below are the filters the
// spec defines; the type is exported so a caller can hold a slice of them,
// not so they can write their own.
...
func (a *AppsClient) List(ctx context.Context, filters ...AppFilter) ([]Application, error) {
...
func (a *AppsClient) ListByUser(ctx context.Context, userID string, filters ...AppFilter) ([]Application, error) {
...
func (a *AppsClient) GetByNameAndNamespace(ctx context.Context, name, namespace, userID string) (*Application, error) {
...
func (a *AppsClient) GetByID(ctx context.Context, appID, userID string) (*Application, error) {
...
func (a *AppsClient) Create(ctx context.Context, userID string, app Application) (*Application, error) {
...
func (a *AppsClient) Update(ctx context.Context, appID, userID string, app Application) (*Application, error) {
	app.UserId = &userID
