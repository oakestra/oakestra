...
type RandomFitLatencyAware struct {
...
func (a RandomFitLatencyAware) ResourceList() []LatencyAwareResources {
	var data []LatencyAwareResources
	return data
}

func (a RandomFitLatencyAware) JobData() LatencyAwareResources {
	var data LatencyAwareResources
	return data
}

func (a *RandomFitLatencyAware) Calculate(job LatencyAwareResources, candidates []LatencyAwareResources) (LatencyAwareResources, error) {
	if len(candidates) == 0 {
	...
	res := filteredCandidates[rand.Intn(len(filteredCandidates))]
...
func (a RandomFitLatencyAware) filterRequirements(job LatencyAwareResources, candidates []LatencyAwareResources) []LatencyAwareResources {
...
func (a RandomFitLatencyAware) checkLatencyRequirement(job LatencyAwareResources, candidate LatencyAwareResources) bool {
