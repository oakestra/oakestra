...
type LowestCarbonFitLatencyAware struct {
...
func (a LowestCarbonFitLatencyAware) ResourceList() []LatencyAwareResources {
	var data []LatencyAwareResources
	return data
}

func (a LowestCarbonFitLatencyAware) JobData() LatencyAwareResources {
	var data LatencyAwareResources
	return data
}

func (a *LowestCarbonFitLatencyAware) Calculate(job LatencyAwareResources, candidates []LatencyAwareResources) (LatencyAwareResources, error) {
	if len(candidates) == 0 {
	...
	slices.SortStableFunc(filteredCandidates, cmpCarbonIntensity)
...
func (a LowestCarbonFitLatencyAware) filterRequirements(job LatencyAwareResources, candidates []LatencyAwareResources) []LatencyAwareResources {
...
func (a LowestCarbonFitLatencyAware) checkLatencyRequirement(job LatencyAwareResources, candidate LatencyAwareResources) bool {
...
// cmpCarbonIntensity compares two candidates according to their carbon intensity
func cmpCarbonIntensity(a LatencyAwareResources, b LatencyAwareResources) int {
