...
from services.service_management import create_services_of_app, generate_db_structure, delete_service, update_service, \
    user_services, get_service, get_all_services
...
def test_delete_service():
    ...
    result, code = create_services_of_app("Admin", sla)
    db_app_before_deletion = apps_db.mongo_find_app_by_name_and_namespace(sla["applications"][0]["application_name"],
                                                                          sla["applications"][0][
    ...
    db_app_after_deletion = apps_db.mongo_find_app_by_name_and_namespace(sla["applications"][0]["application_name"],
                                                                         sla["applications"][0][
                                                                             "application_namespace"])
