...
from ext_requests.cluster_db import (
    ...
    mongo_find_cluster_by_location,
    mongo_find_cluster_by_id_and_set_number_of_nodes,
...
from ext_requests.scheduler_requests import (
...
def on_connect():
    app.logger.info(
        "SocketIO - Cluster_Manager connected: {}".format(request.remote_addr)
    )
