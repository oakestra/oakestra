...
class BlueprintTestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.app.register_blueprint(applicationblp)
        self.client = self.app.test_client()

    @patch("api.v1.apps_blueprint.apps_db.find_all_apps")
    def test_get_all_apps(self, mock_find_all_apps):
        expected = [
            {"_id": "65d200f3812caeb85e21ee19", "application_name": "app1"},
            {"_id": "65d200f3812caeb85e21ee12", "application_name": "app2"},
        ]
        mock_find_all_apps.return_value = [
