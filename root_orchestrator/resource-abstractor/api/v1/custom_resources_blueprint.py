...
import jsonschema
from db import custom_resources_db as custom_resources
...
customblp = Blueprint("Custom Resources", "custom_resources", url_prefix="/api/v1/custom_resources")
...
class CustomResourceController(MethodView):
    ...
    def get(self):
        return list(custom_resources.find_custom_resources())
    ...
    def post(self, data, *args, **kwargs):
        return custom_resources.create_custom_resource(data)
...
class ResourcesController(MethodView):
    def get(self, *args, **kwargs):
        ...
        meta_data = custom_resources.find_custom_resource_by_type(resource_type)
        if meta_data is None:
            abort(404, message="Custom Resource not registered")

        result = list(custom_resources.find_resources(resource_type, filter))
    ...
    def post(self, data, *args, **kwargs):
        ...
        result = custom_resources.create_resource(resource_type, data)
...
class ResourceController(MethodView):
    def get(self, *args, **kwargs):
        ...
        result = custom_resources.find_resource_by_id(resource_type, resource_id)
    ...
    def patch(self, data, *args, **kwargs):
        ...
        result = custom_resources.update_resource(resource_type, resource_id, data)
    ...
    def delete(self, *args, **kwargs):
        ...
        custom_resources.delete_resource(resource_type, resource_id)
