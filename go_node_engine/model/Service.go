...
const (
	...
	SERVICE_MIGRATION_REQUESTED = "MIGRATION REQUESTED"
	SERVICE_MIGRATION_ACCEPTED  = "MIGRATION ACCEPTED"
	SERVICE_MIGRATION_PROGRESS  = "MIGRATION IN PROGRESS"
	SERVICE_MIGRATION_DEBOUNCE  = "MIGRATION DEBOUNCING"
)
