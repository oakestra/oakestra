...
MONGO_ADDR_CANDIDATES = f"{MONGO_BASE_ADDR}/candidates"
...
def mongo_init(flask_app):
    ...
    global mongo_candidates, mongo_jobs, mongo_apps, mongo_hooks
    global app
    ...
    mongo_candidates = PyMongo(app, uri=MONGO_ADDR_CANDIDATES).db["candidates"]
